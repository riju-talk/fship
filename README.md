...
## Serviceability Backend (FastAPI)

This workspace now includes a Python backend for serviceability checks.
...
- `serviceability_router.py`
- `main.py`
- `check_serviceability.html`
- `requirements.txt`
...
```sh
curl -X POST "http://127.0.0.1:8000/api/check-serviceability?pickup_pincode=560001&destination_pincode=110001&user_id=demo_user"
```
